...
function writeWindowsSetupLauncher(script){
  ...
  const body = [
    ...
    'echo This command window starts the interactive PowerShell Setup Wizard.',
    'echo Do not close this window until the wizard says setup is complete.',
    'echo.',
    'echo [How to proceed]',
    'echo 1. If Windows asks for permission or shows SmartScreen, choose Run/Allow.',
    'echo 2. If WSL2 or Ubuntu is missing, follow the prompt, restart Windows if asked,',
    'echo    then open Hermes CEO Console and press First Install again.',
    ...
    'echo 4. When the wizard asks about Hermes/Codex/Telegram/Paperclip, follow each',
    'echo    prompt. You may skip optional integrations and configure them later.',
    'echo 5. When the wizard finishes, go back to the Hermes CEO Console app and press',
